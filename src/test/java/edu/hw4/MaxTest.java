...
class MaxTest extends Assertions {
    ...
    private static final Max<Integer> M = new Max<>();
    ...
    @org.junit.jupiter.api.Test
    void testOrdered() {
        assertEquals(Optional.of(10), M.all(ORDERED));
    }

    @org.junit.jupiter.api.Test
    void testReversed() {
        assertEquals(Optional.of(10), M.all(REVERSED));
    }

    @org.junit.jupiter.api.Test
    void testMixed() {
        assertEquals(Optional.of(10), M.all(MIXED));
    }

    @org.junit.jupiter.api.Test
    void testWithDuplicates() {
        assertEquals(Optional.of(5), M.all(WITH_DUPLICATES));
    }
}
