...
/**
 * Class that evaluates the sixteenth expression.
 */
public final class Expression16 extends ExpressionSystem {
    /**
    ...
    /**
     * Constructor for the sixteenth expression.
     *
     * @param a the value of the parameter a
     * @param b the value of the parameter b
     */
    public Expression16(final double a, final double b) {
        super(new PartitionExpression() {
            public double evaluate(final double value) {
                return Math.cos(value + a * a);
            }
