...
final class Expression13Test extends ExpressionTest {
    private final static double EXPRESSION_EDGE = 2.0;

    public Expression13Test() {
        super(13);
    }
    ...
    edgeExpressionArgsProviderFactory() {
        return Stream.of(
            ...
            new ExpressionTestArgs(-2.0, 1.0, EXPRESSION_EDGE)
        );
    }
    ...
    commonExpressionArgsProviderFactory() {
        return Stream.of(
            ...
            new ExpressionTestArgs(3.0, 15.0, 6.0),
    ...
    illegalExpressionArgsProviderFactory() {
        return Stream.of(
            ...
            new ExpressionTestArgs(-65.0, 15.0, 3.0)
        );
    }
}
