...
class SplittedValuesTest extends Assertions {
    ...
    private static final SplittedValues<Integer> S =
        new SplittedValues<>(integer -> integer % 2 == 0);
    ...
    void testOrdered() {
        ...
        assertArrayEquals(new Integer[] {2, 4, 6, 8, 10}, got.first());
        assertArrayEquals(new Integer[] {1, 3, 5, 7, 9}, got.second());
    }
    ...
    void testMixed() {
        ...
        assertArrayEquals(new Integer[] {2, 4, 8, 10, 6}, got.first());
        assertArrayEquals(new Integer[] {3, 1, 5, 7, 9}, got.second());
    }

    @org.junit.jupiter.api.Test
    void testWithDuplicates() {
        Pair<Integer[], Integer[]> got = S.all(WITH_DUPLICATES);
        assertArrayEquals(new Integer[] {2, 4, 4, 2}, got.first());
        assertArrayEquals(new Integer[] {1, 3, 5, 5, 3, 3, 5}, got.second());
    }
}
